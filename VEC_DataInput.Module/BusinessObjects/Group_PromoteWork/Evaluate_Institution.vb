...
<DefaultClassOptions()>
<XafDisplayName("ผลประเมินสถานศึกษา")>
Public Class Evaluate_Institution ' Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    ...
    <XafDisplayName("ศูนย์ฯ กลุ่มจังหวัด"), RuleRequiredField("Eval_centerId", DefaultContexts.Save), Size(2)>
    ...
    <XafDisplayName("สถานศึกษา"), RuleRequiredField("Eval_InstitutionID", DefaultContexts.Save), Size(10)>
    ...
    Private _QualityLevel As EnumInfo.Quality
    <XafDisplayName("ระดับคุณภาพ"), VisibleInListView(True), VisibleInDetailView(True), RuleRequiredField(DefaultContexts.Save)>
    <RuleValueComparison("ComparisonQuality", DefaultContexts.Save, ValueComparisonType.NotEquals, EnumInfo.Quality.empty)>
    Public Property QualityLevel As EnumInfo.Quality
        Get
            Return _QualityLevel
        End Get
        Set(value As EnumInfo.Quality)
            SetPropertyValue("QualityLevel", _QualityLevel, value)
        End Set
    End Property
