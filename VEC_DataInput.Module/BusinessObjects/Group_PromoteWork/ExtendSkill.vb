...
<DefaultClassOptions()>
<RuleCriteria("MustNotZero", DefaultContexts.Save, "NumOfStudent > 0", "จำนวนนักเรียนอย่างน้อย 1 คน")>
<XafDisplayName("การเพิ่มทักษะให้กับผู้เรียน")>
Public Class ExtendSkill ' Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    ...
    Public Property subjectTypeId As mas_SubjectType
        ...
        Set(value As mas_SubjectType)
            SetPropertyValue("degreeLevelId", _subjectTypeId, value)
            majorId = Nothing
            minorId = Nothing
        End Set
    End Property
    ...
    Public Property minorId As mas_minor
        ...
        Set(ByVal value As mas_minor)
            SetPropertyValue("minorId", _minor_id, value)
            ref_mas_skill = Nothing
        End Set
    End Property

    Private _skill_Oid As mas_Skill
    <XafDisplayName("ทักษะที่เพิ่มให้กับผู้เรียน"), ImmediatePostData(), RuleRequiredField(DefaultContexts.Save), Index(9)>
    Public Property ref_mas_skill() As mas_Skill
        Get
            Return _skill_Oid
        End Get
        Set(ByVal value As mas_Skill)
            SetPropertyValue("ref_mas_skill", _skill_Oid, value)

        End Set
    End Property

    Private _NumOfStudent As Integer
    <XafDisplayName("จำนวนนักเรียน"), VisibleInDetailView(True), VisibleInListView(True), RuleRequiredField(DefaultContexts.Save), Index(10)>
