...
<DefaultClassOptions()>
<XafDisplayName("การส่งเสริมให้เป็นผู้ประกอบการที่ใช้นวัตกรรม")>
<RuleCriteria("NumStdInnoEntNotZero", DefaultContexts.Save, "NumOfStudent > 0", "กรุณากรอกรจำนวนนักเรียนให้ถูกต้อง")>
Public Class PromoteInnvtEnt ' Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    ...
    <XafDisplayName("ลักษณะธุรกิจ"), VisibleInDetailView(True), VisibleInListView(True), RuleRequiredField(DefaultContexts.Save)>
    Public Property BusinessType As String
        Get
            Return _BusinessType
        End Get
        Set(ByVal value As String)
            SetPropertyValue("BusinessType", _BusinessType, value)
        End Set
    End Property

    Private _NumOfStudent As Integer
    <XafDisplayName("จำนวนนักเรียน"), RuleRequiredField("NumbofStudent", DefaultContexts.Save), VisibleInDetailView(True), VisibleInListView(True), RuleRequiredField(DefaultContexts.Save)>
