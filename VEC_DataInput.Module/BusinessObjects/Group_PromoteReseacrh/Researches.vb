...
<XafDisplayName("งานวิจัยเพื่อการศึกษา"), NavigationItem("Group_Research")>
<DefaultClassOptions()> _
Public Class Researches ' Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    ...
    Private _ReseacrhType As ResearchType
    <XafDisplayName("ประเภทงานวิจัย"), ToolTip("ประเภทงานวิจัย")>
    <ModelDefault("LookupProperty", "ResearchType")>
    <RuleRequiredField(DefaultContexts.Save)>
    Public Property ReseacrhType() As ResearchType
        Get
            Return _ReseacrhType
        End Get
        Set(ByVal value As ResearchType)
            SetPropertyValue("ReseacrhType", _ReseacrhType, value)
        End Set
    End Property

    Private _ResearchName As String
    <XafDisplayName("ชื่องานผลงานวิจัย"), Size(200)>
    <RuleRequiredField(DefaultContexts.Save)>
    Public Property ResearchName() As String
        ...
        End Get
        Set(ByVal value As String)
            SetPropertyValue("ResearchName", _ResearchName, value)
        End Set
    End Property
