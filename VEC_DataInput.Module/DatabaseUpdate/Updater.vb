...
Public Class Updater
    ...
    Public Overrides Sub UpdateDatabaseAfterUpdateSchema()
        ...
        Dim userAdmin As User = ObjectSpace.FindObject(Of User)(New BinaryOperator("UserName", "Admin"))
        If userAdmin Is Nothing Then
            userAdmin = ObjectSpace.CreateObject(Of User)()
            userAdmin.UserName = "Admin"
            userAdmin.SetPassword("")
        End If
        ...
        If adminRole Is Nothing Then
            ...
            adminRole.Name = "Administrators"
            adminRole.Description = "สำหรับผู้ดูแลระบบ"
            adminRole.IsAdministrative = True
        End If
        userAdmin.CreateDate = Now
        userAdmin.DisplayName = "ผู้ดูแลระบบ"
